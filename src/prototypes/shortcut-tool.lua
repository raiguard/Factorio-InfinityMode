...
data:extend{
    -- shortcut
    {
        ...
        icon = shortcut_sprite('map-editor-x32.png', 32),
        disabled_icon = shortcut_sprite('map-editor-x32-white.png', 32),
        small_icon = shortcut_sprite('map-editor-x24.png', 24),
        disabled_small_icon = shortcut_sprite('map-editor-x24-white.png', 24),
        action = 'lua',
